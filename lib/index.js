...
const mainPlatform = new Platform(0, 500, 800, 0, 64, 264, 12);
const topLeft = new Platform(0, 150, 100, 0, 0, 64, 16);
const topCenter = new Platform(275, 180, 175, 180, 0, 180, 16);
const topRight = new Platform((canvasWidth - 125), 150, 125, 72, 0, 100, 16);
const bottomLeft = new Platform(0, 350, 125, 185, 0, 175, 16);
const bottomCenter = new Platform(300, 400, 125, 232, 32, 132, 16);
const bottomRightA = new Platform(550, 325, 125, 0, 32, 116, 16);
const bottomRightB = new Platform((canvasWidth - 130), 350, 130, 116, 32, 108, 12);
