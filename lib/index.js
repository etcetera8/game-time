...
const lavaPlatform = new Platform(0, 550, 800, 50);
...
platformArr.push(mainPlatform, lavaPlatform, topLeft, topCenter, topRight, bottomLeft, bottomCenter, bottomRightA, bottomRightB);
let p1 = playerArr[0];
let p2 = playerArr[1];
